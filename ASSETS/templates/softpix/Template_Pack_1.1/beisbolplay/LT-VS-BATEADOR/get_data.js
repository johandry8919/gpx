    ...
    gapi.client.sheets.spreadsheets.get({
        ...
        for (var i = 0; i < sheets.length; i++) {
            ...
            gapi.client.sheets.spreadsheets.values.get({
                ...
                $('#bx-player-1 .name').text(valueData['JUGADOR'][7]);
                $('#bx-player-2 .name').text(valueData['JUGADOR'][8]);
                var clasesA = valueData['EQUIPO'][7];
                var clasA = clasesA.toLowerCase();
                var clasesB = valueData['EQUIPO'][8];
                ...
                getPlayerA(valueData['CODE'][7]);
                getPlayerB(valueData['CODE'][8]);
            }, function (error) {
                console.log(error);
            });
        }
